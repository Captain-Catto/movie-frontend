...
const TYPE_CONFIG: Record<string, { badge: string; label: string; headerGradient: string; icon: React.ReactNode }> = {
  warning: {
    ...
    icon: (
      <svg className="size-14 text-yellow-400 drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  info: {
    ...
    icon: (
      <svg className="size-14 text-blue-400 drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  success: {
    ...
    icon: (
      <svg className="size-14 text-green-400 drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  error: {
    ...
    icon: (
      <svg className="size-14 text-red-400 drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  system: {
    ...
    icon: (
      <svg className="size-14 text-purple-400 drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
