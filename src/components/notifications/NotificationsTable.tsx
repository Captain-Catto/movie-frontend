          ...
          {loading ? (
            ...
            notifications.map((notification) => (
              <tr key={notification.id} className="hover:bg-gray-750">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300" suppressHydrationWarning>
        ...
        <div className="px-6 py-4 bg-gray-800 border-t border-gray-700 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
            >
              Previous
            </button>
                ...
                (acc, page) => {
                  ...
                  acc.els.push(
                    <div key={page} className="flex items-center">
                      {acc.prevPage !== null && acc.prevPage !== page - 1 && (
